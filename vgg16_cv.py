...
if __name__ == '__main__':
    ...
    for file in os.listdir('/project/roysam/aditi/classification/BreaKHis_v1/dataset'):
    	if file.endswith('.png'):
		name=os.path.join('/project/roysam/aditi/classification/BreaKHis_v1/dataset/',file)
		base_name = name[:-4]
		img1 = imread(name)
		...
		np.save(base_name,prob)
                print(len(prob))
    #name = 'BreaKHis_v1/histology_slides/breast/malignant/SOB/ductal_carcinoma/SOB_M_DC_14-11031/100X/SOB_M_DC-14-11031-100-001.png'#laska.png')
